...
codes = [{"code":"B624000","system":"readv2"},{"code":"B67..00","system":"readv2"},{"code":"B67y.00","system":"readv2"},{"code":"B67yz00","system":"readv2"},{"code":"B67z.00","system":"readv2"},{"code":"BBr0.00","system":"readv2"},{"code":"BBr0z00","system":"readv2"},{"code":"ByuD800","system":"readv2"}];
REQUIRED_CODES = 1;
